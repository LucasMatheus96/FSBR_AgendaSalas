...
namespace FSBR_AgendaSalas.MVC.Controllers
{
    public class UsuarioController : Controller
    {
        ...
        public async Task<IActionResult> Create(UsuarioViewModel model)
        {
            ...
            var response = await _httpClient.PostAsync("https://localhost:7081/api/Usuario", jsonContent);
        ...
        public async Task<IActionResult> Edit(UsuarioViewModel model)
        {
            ...
            var response = await _httpClient.PutAsJsonAsync($"https://localhost:7081/api/Usuario/{model.Id}", model);
            return RedirectToAction("Index");
        }
        ...
        {
            var response = await _httpClient.DeleteAsync($"https://localhost:7081/api/Usuario/{id}");
            return RedirectToAction("Index");
        }
    }
}
